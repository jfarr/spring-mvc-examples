...
* [hibernate-example](https://github.com/jfarr/spring-mvc-examples/tree/master/hibernate-example)Example HTML / JSON application with an HSQL database back-end using Hibernate and JPA annotations.
